...
| Couche | Choix |
|---|---|
| Langage | Python 3.13 (3.11 min sur RPI4) |
...
| Haute dispo | Watchdog matériel BCM2835 (reboot auto si kernel panic) |
...
[Pierroons](https://github.com/Pierroons) — paysan le jour, dans un terminal le soir.
