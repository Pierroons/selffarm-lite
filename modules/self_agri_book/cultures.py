"""
self_agri_book.cultures — CRUD parcelle + plan_culture + catalogue variétés.

Storage : tables `parcelle` + `plan_culture` (migrations 5+6 dans storage.py).
...
_YAML_PATH = (
    ...
    / "self_culture" / "data" / "varietes-references.yaml"
)
