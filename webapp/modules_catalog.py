...
CATALOG: tuple[Module, ...] = (
    ...
    Module("compta", "Comptabilité", "gestion", "chart", "live",
           ...
           modes=("lite", "full"), core=True),
    Module("achats", "Achats fournisseurs", "gestion", "receipt", "live",
           (NavItem("Factures reçues", "/achats", "/achats"),),
           modes=("lite", "full"),
           desc="Factures fournisseurs reçues via une plateforme agréée (obligation de réception depuis le 01/09/2026). Lues, contrôlées, puis imputées après validation."),
